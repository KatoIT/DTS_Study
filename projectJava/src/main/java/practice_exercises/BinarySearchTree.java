...
//
//        practice_exercises.BinarySearchTree<String> btsDemo = new practice_exercises.BinarySearchTree<>();
//        btsDemo.insert("I");
//        btsDemo.insert("E");
//        btsDemo.insert("C");
//        btsDemo.insert("Z");
...
//         * String
//         * */
//        practice_exercises.BinarySearchTree<Integer> BTInt = new practice_exercises.BinarySearchTree<>();
//        BTInt.insert(15);
//        BTInt.insert(1);
//        BTInt.insert(71);
//        BTInt.insert(9);
